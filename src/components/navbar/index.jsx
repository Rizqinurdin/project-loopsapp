  ...
  return (
    <div className="w-full shadow shadow-xl shadow-kedua ring-2 ring-kedua z-50 fixed top-0">
      <div className=" bg-gray-50 py-4 md:justify-between md:px-10 px-7">
        <div className="grid grid-flow-col grid-cols-6 grid-rows-1 pr-48">
          <div className="grid justify-items-start md:justify-between col-span-2">
            <img className="w-36" src={require("./loops.png")} alt="" />
          </div>
          ...
          <div className="col-span-2 font-serif text-2xl text-left font-semibold text-kedua">
            List Of Transaction
          </div>
          <div></div>
        </div>
